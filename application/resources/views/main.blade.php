...
<html>
    <head>
        ...
        <link rel="stylesheet" id="main-stylesheet"
              href="{{ asset('assets/css/custom-stylesheets', $settings->get('enable_https')).'/'.(($settings->get('selected_sheet') && ! IS_DEMO) ? $settings->get('selected_sheet').'/styles.min.css?v17' : 'original/styles.min.css?v17') }}">
    ...
    <body ng-app="app" global-dropdown-close ng-controller="AppController">
        ...
        <script src="{{ asset('assets/js/core.min.js?v17', $settings->get('enable_https')) }}"></script>
